<%@ Page Title="" Language="C#" MasterPageFile="masterpage.Master" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="kstarbox.login" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div class="logincontent">
        ...
        <div class="loginbutton"><asp:Button ID="Button1" runat="server" Text="Sign in" style="height: 26px" OnClick="loginbtn" /></div>
    ...
    <div class="registercontent">
       ...
       <div class="reglabel"> <asp:Label ID="regusernamelbl" runat="server" Text="Username: "></asp:Label></div>
        <div class="regtxtbox"><asp:TextBox ID="regusernametxt" runat="server" Width="200px" CausesValidation="True"></asp:TextBox></div> 

<%@ Page Title="" Language="C#" MasterPageFile="masterpage.Master" AutoEventWireup="true" CodeBehind="itemDetails.aspx.cs" Inherits="kstarbox.WebForm2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="navbar">
            <ul>
                ...
                <li><a class="selected" href="Product.aspx">PRODUCTS</a></li>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
     ...
     <div class="products"><asp:Literal ID="prodnametxt" runat="server"></asp:Literal></div>
        <div id="itemwrapper">
            ...
            <div class="cart">
                <asp:Button ID="addtocart" runat="server" OnClick="addcart_Click" Text="Buy" style="width: 60px" />
             </div>

<%@ Page Title="" Language="C#" MasterPageFile="masterpage.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="kstarbox.product" %>
        ...
        <ItemTemplate>
           ...
           <img src="./prodImg/<%#Eval("imgName") %><%#Eval("extension") %>" alt="<%#Eval("altText") %>"/>
                <div class="prodtext">
                    ...
                    <a class="morebutton" href="itemDetails.aspx?id=<%#Eval("prod_name") %>" title="moreinfo">More info</a>
                </div>
